...
const currentUser = localStorage.getItem("userId")
	...
	const handleSubmit = (e) => {
		...
		console.log("Guest Count Valid:", isGuestCountValid());
		console.log("Check-Out Date Valid:", isCheckOutDateValid());
	
		if (form.checkValidity() === false || !isGuestCountValid() || !isCheckOutDateValid()) {
			e.stopPropagation();
			setValidated(false); // Mark form as invalid
			return; // Stop further execution
		}
	
		setValidated(true); // Mark form as valid
		setIsSubmitted(true); // Proceed to submission
	};
