...
const ExistingRooms = () => {
    const [rooms, setRooms] = useState([{ id: "", roomType: "", roomPrice: "", location: "", description: "" }]);
    const [currentPage, setCurrentPage] = useState(1);
    const [roomsPerPage] = useState(8);
    const [isLoading, setIsLoading] = useState(false);
    const [filteredRooms, setFilteredRooms] = useState([{ id: "", roomType: "", roomPrice: "", location: "", description: "" }]);
                    ...
                    <section className="mt-5 mb-5 container">
                        ...
                        <Row>
                            ...
                            <Col md={6} className="d-flex justify-content-end">
                                <Link to={"/add-room"} className="btn btn-primary btn-lg d-flex align-items-center gap-2">
                                    <FaPlus /> Add Room
                                </Link>
                            </Col>
                        </Row>
